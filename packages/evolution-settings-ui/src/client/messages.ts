...
export const zh = {
  ...
  discard: '放弃修改',
  saving: '保存中…',
  refused: '写入未被接受——宿主的校验拒绝了它（值保持原样）。原因见 /evolution params 或 /evolution doctor。',
  cardReview: '审查',
  cardMemory: '记忆',
  cardToolMemory: '记忆工具',
  cardCurator: '策展',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  discard: 'Discard',
  saving: 'Saving…',
  refused: 'The write was not accepted — the Host refused it and the value is unchanged. See /evolution params or /evolution doctor for the reason.',
  cardReview: 'Review',
  cardMemory: 'Memory',
