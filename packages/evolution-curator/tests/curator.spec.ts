...
describe('P2-5 (v15)/v16: control-plane mutators serialize on the mutex chain', () => {
  it('restore() queues behind a held mutex, resumes on release, and never spins the event loop', async () => {
    // The queue wait uses a REAL macro-task boundary: under the v15 draft
