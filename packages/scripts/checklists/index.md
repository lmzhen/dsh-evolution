...
|---|---|---|---|
| New package | [new-package.md](./new-package.md) | `templates/package/package.json.tmpl`, `templates/package/src-index.ts.tmpl`, `templates/package/README.tmpl.md` | `verify-dependency-closure.mjs`, `verify-arch-guards.mjs` (N1/N3/N5/N7/N8), `check-manifests.cjs`, `tsc -b`, `oxlint` |
...
- **The mirror is the source.** Edit `packages/...` here, then
  `node D:\dsh\audit-v37\mirror-sync.mjs sync`; `mirror-sync.mjs check` must end
  `differ=0 onlyOverlay=0`.
