...
|---|---|---|---|
| New package | [new-package.md](./new-package.md) | `templates/package/package.json.tmpl`, `templates/package/src-index.ts.tmpl`, `templates/package/README.tmpl.md` | `verify-dependency-closure.mjs`, `verify-arch-guards.mjs` (N1/N3/N5/N7/N8), `verify-package-discovery.mjs` (a package the release would publish but the source installer would not accept), `tsc -b`, `oxlint` |
